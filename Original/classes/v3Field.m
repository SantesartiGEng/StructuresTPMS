                ...
                case "TPMS"
                    ...
                    switch data.type
                        case "surface"
                            ...
                            % %%% DEBUG START 2026-01-19
                            % %
                            % F.property.U = (data.u(Xt,Yt,Zt) - F.property.V1).*(data.u(Xt,Yt,Zt) - F.property.V2);a
                            % %
                            % % RESULT: it is equivalent from above, the only
                            % % difference is that the triangle normals are opposite; 
                            % % therefore it's better to use the aa
                            % %
                            % %%% DEBUG END 2026-01-19
                        ...
                        case "single"
                            ...
                            % %%% EDIT START 2026-01-19
                            % %
                            % F.property.U = data.u(Xt,Yt,Zt) - F.property.V1;
                            % %
                            % % Commented on 2026-01-26 in order to have a
                            % % decreasing isovalue-relative density relationship as
                            % % in AlKetan2019
                            % %
                            % %%% EDIT END 2026-01-19
